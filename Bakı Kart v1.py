...
while True:
    try:
        ...
        limit_status = Decimal("0.00")
        pass_count = 0
        payment_amount = Decimal("0.00")
        endirim_miqdari = Decimal("0.00")
        for i in range(3):
        ...
        while userkey == True:
            ...
            if selection == 1:
                ...
                if current_balance > current_rejim:
                    ...
                    endirim_miqdari = Decimal("4.20") - current_rejim
                    pass_count += 1
                    payment_amount += current_rejim
                elif current_balance - Decimal("1.00") <= current_rejim:
                    current_balance -= Decimal("2.60")
                    current_debt = current_debt + current_rejim - Decimal("2.60:")
                    print("Turniketdən keçə bilərsiniz.")
                    current_last_ops.append("Turniket keçişi:{} AZN".format(current_rejim))
                    endirim_miqdari = Decimal("4.20") - current_rejim
                    pass_count += 1
